...
class Settings:
    ...
    # Database: Default to local SQLite for isolated execution, supports PostgreSQL via DATABASE_URL
    DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite:///./storage/evidence.db")
